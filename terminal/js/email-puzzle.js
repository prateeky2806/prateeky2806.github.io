/* ============================================================
   email-puzzle.js — Email reveal puzzles (retro-terminal theme)
   Three puzzle types: Shards, Wipe, Decrypt
   ============================================================ */
...
(function () {
  ...
  /* ============================================================
     PUZZLE 1: Shards — Progressive reveal
     ============================================================ */
  function initShardsPuzzle(container) {
    container.innerHTML = '<p style="color:var(--gray-light);margin-bottom:0.75rem;font-size:0.85rem;">$ reconstruct email --mode=shards</p><div class="shard-pieces"></div>';
    ...
    var nextIndex = 0; // index into SHARD_PIECES (ordered)
  ...
  /* ============================================================
     PUZZLE 2: Wipe — Canvas scratch-to-reveal
     ============================================================ */
  function initWipePuzzle(container) {
    container.innerHTML =
      '<p class="wipe-instruction">$ decrypt email --mode=scratch</p>' +
    ...
    // Fill canvas with opaque layer
    ctx.fillStyle = '#0a0a0a';
    ctx.fillRect(0, 0, canvas.width, canvas.height);

    // Add hint text on top
  ...
  /* ============================================================
     PUZZLE 3: Decrypt — Hold button to decode
     ============================================================ */
  function initDecryptPuzzle(container) {
    container.innerHTML =
      '<div class="decrypt-container">' +
        '<p style="color:var(--gray-light);margin-bottom:0.75rem;font-size:0.85rem;">$ decrypt email --mode=bruteforce</p>' +
    ...
    var progress = 0; // 0 to fullEmail.length
    var interval = null;
    var decrypted = false;
